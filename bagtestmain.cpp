...
*   05/14/2024 -- Updated for Fall 2024
*   11/01/2024 -- Updated for Spring 2025
*   04/24/2025 -- Updated for Fall 2025
* 	12/22/2025 -- Updated for Spring 2026
*   04/24/2026 -- Updated for Fall 2026
*/
...
int main() {
	...
	cout << "Chace Eichmeier -- CSCN 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
	...
	int intKey = 40;
	strData = "ERROR!!!";
	if (myIntStrDict.search(intKey, strData) == true) {
	...
	myStrIntDict.insert("Terri", 71);
	myStrIntDict.insert("Beth", 67);
	myStrIntDict.insert("Harper", 4);
	myStrIntDict.insert("The Twins", 2);	
	myStrIntDict.insert("Jeremy", 33);
	myStrIntDict.insert("Nathan", 31);
	myStrIntDict.insert("Zipper", 15);
	myStrIntDict.insert("Liberty", 55);
	myStrIntDict.insert("USA", 250);
	...
	string strKey = "Zipper";
	if (myStrIntDict.search(strKey, intData) == true) {
