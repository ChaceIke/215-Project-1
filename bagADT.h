...
* Modified on 9/4/2014 -- Changed "const T& inspectTop() const" to 
*   "bool   inspectTop(const T& item) const".
...
* Modified on 04/24/2025 by Prof Sipantzi
* Modified on 11/10/2025 by Prof Sipantzi
* Modified on 04/24/2026 by Prof Sipantzi
*/
